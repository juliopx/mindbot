...
export function createMemorySearchTool(options: {
  ...
  return {
    ...
    description:
      "Mandatory recall step: semantically search MEMORY.md (facts, data, decisions) + memory/*.md (daily logs) before answering questions about prior work, decisions, dates, people, preferences, or todos; returns top snippets with path + lines.",
